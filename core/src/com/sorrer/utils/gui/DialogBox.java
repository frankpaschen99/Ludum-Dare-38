...
public class DialogBox {
	...
	/**
	 * Tests if stepping is still possible. If it is possible return true and
	 * add one to step;
	 * 
	...
	/**
	 * Grabs and returns current line step is on. Returns an empty string if not
	 * possible.
	 * 
	 * @return Current line
	 */
	...
	/**
	 * Get dialog lines that are related to the current box of dialogs(cur -
	 * maxLines through cur).
	 */
